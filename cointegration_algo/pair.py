...
class Pair():
    ...
    def __init__(self, s1, s2, data_source):
        ...
        self.ou_beta = arg_max_B_alloc(self.price_B, self.price_A)[-1]
        self.position = 0
        # self.update_spread()
    ...
    def update_entry_point(self):
        self.lower_enter, self.upper_enter = (
        self.ma_spread - 2 * self.std_spread, self.ma_spread + 2 * self.std_spread)
